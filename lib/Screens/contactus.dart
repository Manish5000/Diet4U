              ...
              child: Center(child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text('9799476698',style: GoogleFonts.urbanist(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 18),),
                    SizedBox(height: MediaQuery.of(context).size.height*0.050,),
                    LottieBuilder.asset('assets/contactus.json'),
                    SizedBox(height: MediaQuery.of(context).size.height*0.050,),
                    Text('Thank You',style: GoogleFonts.urbanist(color: Colors.black45,fontWeight: FontWeight.normal,fontSize: 14),),
